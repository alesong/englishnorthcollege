                ...
                <div class="card-body">
                    ...
                    <form id="registroForm" action="<?php echo BASE_URL; ?>registro" method="POST">
                        ...
                        <div class="d-grid gap-2">
                            <button id="btn-registarse" type="submit" class="p10 btn-btn btn-lila f20">Registrarse</button>
                            <div class="alert oculto" role="alert" id="alert-error-registro">
                                ...
                                <div class="row mt10 form-verify oculto">
                                    ...
                                    <div class="col"><button type="button" class="p10 btn-primary form-control" id="verificarCodigo">Verificar</button></div>
                                </div>
                            </div>
